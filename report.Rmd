...
Additional codes were also created for project analysis only outside the Shiny app, they were provided in project.R in the github repository for reference `https://github.com/LDY681/CITS4009-project`. 
